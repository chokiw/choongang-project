...
<body>
	<div class="container">
		...
		<main class="content">
			<div class="track">
				<span style="font-size: 36px; font-weight: 700;">나의 참가 리스트</span><br>
				<br> <span style="color: gray;">나의 참가 리스트입니다.</span>
			</div>
			<br>
			...
			<c:choose>
				...
				<c:when test="${isWriter}">
					<a
						href="mate_detail?pageNum=${pageNum}&recruit_no=${alarm.recruit_no}">
						이곳을 누르면 작성하셨던 글로 이동합니다. </a>
				</c:when>

				<%-- 내가 다른 사람의 글에 참가 신청한 경우 --%>
				<c:otherwise>
					<a href="mate_detail?pageNum=${pageNum}&recruit_no=${alarm.recruit_no}">
						이곳을 누르면 참가 신청한 글로 이동합니다. </a>
				</c:otherwise>
			</c:choose>
