		...
		<main class="content">
			...
			<form method="post" action="matewrite" onsubmit="return check()">
				...
				<div class="sns_writer">
					...
					</select> <span class="mate_count"> 모집 인원 : <input type="number"
		...
		$(document).ready(function() {
			$('#next').click(function() {
				if (clickLine != null) {
					...
					var distance = Math.round(clickLine.getLength());
					data = "arr=" + arr+"&distance="+distance;
					$.post('${pageContext.request.contextPath }/real',data,function() {});
				}
			});
		});
	</script>
				...
				<div style="margin-top: 20px; height: auto;">
					...
					<textarea name="sns_content" id="sns_content" rows="8" cols="50"
						style="width: 90%;" id="recruit_content" name="recruit_content"
						placeholder="내용을 입력해주세요"></textarea>
				</div>

				<div class="button-container">

					<button type="button" class="action-button remove">경로 뒤로
						한칸 이동</button>
